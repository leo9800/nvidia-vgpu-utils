...
pkgname=('nvidia-vgpu-17-utils' 'nvidia-vgpu-17-utils-unlock')
pkgbase=nvidia-vgpu-17-utils
pkgver=550.163.02
pkgrel=1
arch=('x86_64')
...
package_nvidia-vgpu-17-utils() {
	pkgdesc="NVIDIA vGPU drivers utilities v17"
	_utils "${srcdir}/${_pkg}"
}

package_nvidia-vgpu-17-utils-unlock() {
	pkgdesc="NVIDIA vGPU drivers utilities v17, with vGPU unlock patch"
